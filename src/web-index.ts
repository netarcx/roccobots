...
console.log("\nAuto-starting enabled bots...");
try {
  await botManager.startAll();
  console.log("Bot auto-start complete.");
} catch (error) {
  console.error("Bot auto-start error:", error);
}

// Start periodic log pruning
botManager.startLogPruning();
